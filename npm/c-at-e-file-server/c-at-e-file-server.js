...
function pkgForCurrentPlatform() {
    ...
    throw new Error(`Unsupported platform: "${platformKey}". "@jakechampion/compute-file-server does not have a precompiled binary for the platform/architecture you are using. You can open an issue on https://github.com/jakechampion/compute-file-server/issues to request for your platform/architecture to be included."`);
}
